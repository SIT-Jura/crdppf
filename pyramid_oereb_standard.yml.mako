...
pyramid_oereb:
  ...
  app_schema:
    ...
    #db_connection: postgresql://${dbuser}:${dbpassword}@${dbhost}:${dbport}/${db_pyramid_oereb}
    db_connection: &main_db_connection
      postgresql://${dbuser}:${dbpassword}@${dbhost}:${dbport}/${db_pyramid_oereb}
  ...
  plr_cadastre_authority:
    ...
    name:
        en: Section du cadastre et de la géoinformation
        de: Section du cadastre et de la géoinformation
